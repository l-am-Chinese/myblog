window.onload = function musichtml(){
	/* 个位数转两位数 */
	function doubleNum(n){
		return (n <10) ? ("0" + n) : (n);
	}
	/* 储存信息 */
	var songName =["Rain", "Bugatti","I Get Lifted","20's 50's 100's","What You Wanna Do","I Want It That Way","What a Fool Believes","Scandalous","Glamorous","W (feat. Gunna)"]
	var singers =["SWV", "Ace Hood","George Mccrae","King Avriel","Kausion","Backstreet Boys","The Doobie Brothers","Mis-Teeq","Fergie","Koffee / Gunna"]
	/* 动态插入css代码片段 */
	var head = $('head')[0];
