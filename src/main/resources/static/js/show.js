    ...
    function putInArticle(data) {
        ...
        var articleTop = $('<article-top><div class="article-title">' +
            ...
            '多年以后，愿你的城市，有清风，有烈酒，也有人是你的归途。<span class="article-i-say-me">--- 张浩晟</span>' +
            '</div>');
        ...
        $('.other').append($('<div class="social-share" data-initialized="true" data-url="http://www.zhanghaosheng.xyz/article/' + data.articleId  + '"  data-title="' + data.articleTitle + '">' +
