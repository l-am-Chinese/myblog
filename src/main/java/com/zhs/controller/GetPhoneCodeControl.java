...
import com.zhs.component.PhoneRandomBuilder;
import com.zhs.redis.StringRedisServiceImpl;
...
public class GetPhoneCodeControl {
     ...
     * 阿里云短信发送模板
     */
    private static final String SIGN_NAME = "上师大张浩晟";
